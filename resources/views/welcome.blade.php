...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('plate') }}/css/bootstrap.css">
    <link rel="stylesheet" href="{{ asset('plate') }}/css/fonts.css">
  ...
  <body>
    ...
    <div class="page">
                ...
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-panel">
                    ...
                    <div class="rd-navbar-brand">
                      <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="{{ $app_logo  }}" alt="" width="181" height="50"/><img class="brand-logo-light" src="{{ $app_logo }}" alt="" width="181" height="50"/></a>
                    </div>
                  </div>
                  <div class="rd-navbar-nav-wrap">
                    <ul class="rd-navbar-nav">
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#programs">Home</a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#about">Outlet</a>
                      </li>
                      <li class="rd-nav-item"><a class="rd-nav-link" href="#clients">Our Menu</a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="swiper-slide-caption section-md">
                <div class="container">
                  <div class="row row-50 align-items-center swiper-custom-row">
                    <div class="col-lg-5">
                        <h3 class="subtitle" data-swiper-anime='{"animation":"swiperContentRide","duration":900,"delay":900}'></h3>
                      <h1 data-swiper-anime='{"animation":"swiperContentRide","duration":1000,"delay":1000}' data-subtext="#1">Makanan Dan Minuman</h1>
                      <p class="big" data-swiper-anime='{"animation":"swiperContentRide","duration":1100,"delay":1100}'>Beragam makanan dan minuman enak tersedia di cafe kami.</p>
                      <p class="postitle" data-swiper-anime='{"animation":"swiperContentRide","duration":1200,"delay":1200}'></p>
                    </div>
                    <div class="box-round-wrap"><img src="{{ asset('plate')  }}/images/slider-01-671x671.png" alt="" width="671" height="335" data-swiper-anime='{"animation":"swiperContentFade","duration":1000,"delay":1000}'/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="swiper-slide-caption section-md">
                <div class="container">
                  <div class="row row-50 align-items-center swiper-custom-row">
                    <div class="col-lg-5">
                        <h3 class="subtitle" data-swiper-anime='{"animation":"swiperContentRide","duration":900,"delay":900}'></h3>
                      <h1 data-swiper-anime='{"animation":"swiperContentRide","duration":1000,"delay":1000}' data-subtext="#2">Tempat Yang Nyaman</h1>
                      <p class="big" data-swiper-anime='{"animation":"swiperContentRide","duration":1100,"delay":1100}'>Tempat yang nyaman dan sejuk dengan view pegunungan.</p>
                      <p class="postitle" data-swiper-anime='{"animation":"swiperContentRide","duration":1200,"delay":1200}'> </p>
                    </div>
                    <div class="box-round-wrap"><img src="{{ asset('plate')  }}/images/slider-02-671x671.png" alt="" width="671" height="335" data-swiper-anime='{"animation":"swiperContentFade","duration":1000,"delay":1000}'/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="swiper-slide-caption section-md">
                <div class="container">
                  <div class="row row-50 align-items-center swiper-custom-row">
                    <div class="col-lg-5">
                        <h3 class="subtitle" data-swiper-anime='{"animation":"swiperContentRide","duration":900,"delay":900}'></h3>
                      <h1 data-swiper-anime='{"animation":"swiperContentRide","duration":1000,"delay":1000}' data-subtext="#3">Delivery Order</h1>
                      <p class="big" data-swiper-anime='{"animation":"swiperContentRide","duration":1100,"delay":1100}'>Selain datang ke tempat, kalian juga bisa lho pesan secara online dan pesanan kami antar ke tempat anda.</p>
                      <p class="postitle" data-swiper-anime='{"animation":"swiperContentRide","duration":1200,"delay":1200}'></p>
                    </div>
                    <div class="box-round-wrap"><img src="{{ asset('plate')  }}/images/slider-03-671x671.png" alt="" width="671" height="335" data-swiper-anime='{"animation":"swiperContentFade","duration":1000,"delay":1000}'/>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row row-50 flex-wrap-md-reverse flex-lg-wrap align-items-lg-center">
            <div class="col-xl-6 col-lg-6">
              <div class="box-custom-2"><img src="{{ asset('plate')  }}/images/shutter-home-01-455x685.png" alt="" width="455" height="342"/>
          ...
          <div class="row row-50 justify-content-center">
            ...
            <div class="col-xl-4 col-md-6">
                ...
                <div class="product novi-bg bg-default">
                  <img class="product-img" src="{{ $product->thumbnail_path }}" alt=""/>
                  <h3 class="product-title">{{ $product->name }}</h3>
                  <div class="product-price">
                    <div class="product-price-header">
                      <div class="product-price-currency">Rp</div>
                      <div class="product-price-value">{{ $product->price /1000 }}k</div>
                    </div>
                  </div>
                  <p class="product-text">{!! $product->description !!}.</p><a class="button button-primary" href="#">See Detail</a>
                </div>
              </div>
            @endforeach
          </div>
      ...
      <section class="section novi-bg novi-bg-img section-custom section-lg bg-primary">
        ...
        <div class="box-custom-3">
          <div class="box-custom-3-img-wrap"><img src="{{ asset('plate')  }}/images/home-01-382x375.png" alt="" width="382" height="187"/>
          </div>
          <div class="box-custom-3-img-wrap"><img src="{{ asset('plate')  }}/images/home-02-293x293.png" alt="" width="293" height="146"/>
          </div>
          <div class="box-custom-3-img-wrap"><img src="{{ asset('plate')  }}/images/home-03-461x407.png" alt="" width="461" height="203"/>
          </div>
          <div class="box-custom-3-img-wrap"><img src="{{ asset('plate')  }}/images/home-04-191x191.png" alt="" width="191" height="95"/>
          </div>
        </div>
      </section>
          ...
          <div class="row row-40 align-items-center">
            <div class="col-lg-6">
              <div class="owl-pagination-custom" id="owl-pagination-custom">
                <div class="data-dots-custom" data-owl-item="0"><img src="{{ asset('plate')  }}/images/shutter-testimonials-01-179x179.png" alt="" width="179" height="89"/>
                </div>
                <div class="data-dots-custom" data-owl-item="1"><img src="{{ asset('plate')  }}/images/shutter-testimonials-02-306x306.png" alt="" width="306" height="153"/>
                </div>
                <div class="data-dots-custom" data-owl-item="2"><img src="{{ asset('plate')  }}/images/testimonials-03-179x179.png" alt="" width="179" height="89"/>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              ...
              <div class="quote-classic-wrap">
                <div class="quote-classic-img"><img src="{{ asset('plate')  }}/images/quote-37x29.png" alt="" width="37" height="14"/>
                </div>
      ...
      <section><a class="d-block" href="https://www.templatemonster.com/landing-page-template/plate-healthy-food-one-page-lean-html-landing-page-template-76237.html" target="_blank"><img class="img-responsive" src="{{ asset('plate')  }}/images/banner-bottom-2050x310.jpg" alt="" width="2050" height="155"/></a></section>
      <footer class="section footer-classic">
        <div class="container">
          <div class="row row-50 justify-content-between">
            <div class="col-xl-3 col-md-6">
              <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="{{ asset('plate')  }}/images/logo-default-363x100.png" alt="" width="181" height="50"/><img class="brand-logo-light" src="{{ asset('plate')  }}/images/logo-inverse-363x100.png" alt="" width="181" height="50"/></a>
    ...
    <script src="{{ asset('plate')  }}/js/core.min.js"></script>
    <script src="{{ asset('plate')  }}/js/script.js"></script>
    <!--coded by kraken-->
  </body>
</html>